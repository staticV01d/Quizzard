...
public class QuizBrain
{
  ...
  /// <summary>
  /// Modify the possible difficulty choices based on category since some are not available
  /// </summary>
  /// <param name="category"></param>
  /// <returns>The list of difficulties, or empty list if category not recognized</returns>
  public static List<string> GetDifficulties(string category)
  {
    return category switch
    {
      "computers" => new List<string>() { "easy", "medium" },
      "video games" => new List<string>() { "easy", "medium", "hard" },
      "history" => new List<string>() { "easy", "medium" },
      "music" => new List<string>() { "easy", "medium" },
      "general" => new List<string>() { "easy", "medium", "hard" },
      _ => new List<string>() { },
    };
  }
